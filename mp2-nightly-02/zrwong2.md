...
```tests/part1.cpp:9:1: fatal error: unknown type name &#x27;Image&#x27;
Image createRainbowImage() {
^
1 error generated.
make: *** [.objs/tests/part1.o] Error 1
```
...
This report was generated for **zrwong2** using **** (from **September 19th 2018, 12:05:00 am**)
